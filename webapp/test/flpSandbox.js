		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Abastecimiento en Linea",
									"targetURL": "#andinaabastecimiento-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"andinaabastecimiento-display": {
								"semanticObject": "andinaabastecimiento",
								"action": "display",
								"description": "Abastecimiento en Linea",
								"title": "Abastecimiento en Linea",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=andina.abastecimiento",
									"url": sap.ui.require.toUrl("andina/abastecimiento")
								}
							}
						}
					}
